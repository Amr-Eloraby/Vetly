...
@section('title', 'Create New Vaccination')
@section('Vaccination', 'active')
@section('content')
<!-- Content -->

    <div class="container-xxl flex-grow-1 container-p-y">
        @if (session('success-create-new-vaccination'))
            <div class="alert alert-success">{{ session('success-create-new-vaccination') }}</div>
        @endif
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Vaccination /</span> Create Vaccination</h4>
        <form action="{{ route('vaccination.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                ...
                <div class="card mb-4">
                    ...
                    <div>
                        ...
                        <select name="animal_type" id="animal_type" class="form-control">
                            ...
                            <option value="Pigeon" {{old('animal_type') == 'Pigeon' ? 'selected' : ''}}>Pigeon</option>
                ...
                <div class="">
                    <div class="card-body">
                        <div class="form-check form-switch mb-4">
                            ...
                            <input class="form-check-input fs-4 mt-2"  type="checkbox" value="1" id="repeatToggle" name="is_repeatable" />
            ...
            <div class="col-md-6">
                <div class="card mb-4" id="repeatField" style="display:none;">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control" id="repeatfield" name="repeat_every_weeks" placeholder="Enter Repeat Interval (Weeks)" value="{{old('repeat_every_weeks')}}">
